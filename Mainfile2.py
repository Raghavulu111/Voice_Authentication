...
if genre == 'Yes':
    ...
    file_up2 = st.file_uploader("Upload an Text", type="txt")
    ...
    st.title('Ecrypted Data')
    
    st.title(encMessage)
    st.write('You selected Data.')
    
    file_up = st.file_uploader("Upload an signal", type="wav")
    st.text(file_up)
...
#            st.line_chart(yy)
    ...
    if int(Class_knn) == 0:
        ...
        st.text("--------------------------------------------------------")
        st.text("                      Text Decryption                   ")
        st.text("--------------------------------------------------------")
    
        st.text(decMessage)    
        st.text("--------------------------------------------------------")
        
    elif int(Class_knn) == 1:
        print('=================')
    ...
    st.text('----- Classification Accuracy ------')
